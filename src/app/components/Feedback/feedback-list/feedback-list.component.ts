...
import { UserService } from 'src/app/services/user.service'; // Ajoutez cette ligne
...
@Component({
  ...
  styleUrls: ['./feedback-list.component.css','../../../../assets/css/style.css',]
})
export class FeedbackListComponent implements OnInit {
  ...
  quickFeedbackForm: FormGroup = new FormGroup({});
  isSubmitting = false;
...
handleImageError(event: Event) {
  ...
  imgElement.src = 'assets/images/Capture.png';
  imgElement.onerror = null; // Empêche les boucles infinies d'erreurs
}
