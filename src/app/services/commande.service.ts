...
export class CommandeService {
  ...
  getItemByCommandeId(id: number): Observable<Item> {
  ...
  // ✅ Récupérer le borrower d'une commande
  getBorrowerByCommandeId(id: number): Observable<User> {
    return this.http.get<User>(`${this.apiUrl}/borrower/${id}`);
  }
}
